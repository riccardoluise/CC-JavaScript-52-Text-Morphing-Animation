...
// Array of patterns to exclude (easily modifiable)
...
function parseGitignore(rootPath) {
    ...
    return patterns.concat(customExclusions);
}
...
function concatenateFiles(rootPath) {
    ...
    output += "This document contains the content of all project files, excluding those specified in .gitignore, node_modules, .git, README.md, concatenate.js, and custom exclusions.\n\n";
